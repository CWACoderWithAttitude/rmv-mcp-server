...
To use this server you need to acquire a free RMV API key. You can request one from RMV via the https://opendata.rmv.de/site/start.html[RMV Open Data Portal].
Once you have it, you can enter it in Claude's config file.
For local testing you should put it in the `.env` file.
